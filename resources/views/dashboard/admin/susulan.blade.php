                ...
                <div class="col-md-7 col-sm-9">
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" name="search"
                            placeholder="Insert (Nama or NIM) Search..." value="{{ request('search') ?? '' }}"
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center d-flex justify-content-center gap-1">
                        ...
                        --}}
                        <button type="button" class="btn btn-sm rounded-pill btn-success" data-bs-toggle="modal"
                            data-bs-target="#verifModal{{ $user->id }}">
                            <i class="bi bi-person-check"></i> Verification
                        </button>
                        {{-- <button class="btn btn-sm rounded-pill btn-success"><i class="bi bi-person-check"></i>
                            Verification</button> --}}
        ...
        <div class="modal-content">
            <form action="{{ route('Import Data Mahasiswa Susulan') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <p>Kolom 1 : Nama Mahasiswa</p>
                    <p>Kolom 2 : NIM Mahasiswa</p>
                    <p>Kolom 3 : E-mail</p>
                    <p>Kolom 4 : No HP </p>
                    <p>Kolom 5 : Jenis Kelamin</p>
                    <p>Kolom 6 : ID Kelas</p>
                    <p>Kolom 7 : ID Jurusan</p>
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('Update Data Mahasiswa Susulan', $user->id) }}" method="post">
                ...
                <div class="modal-body">
                    ...
                    <input class="form-control mb-3" type="text" name="nama" id="nama" value="{{ $user->nama }}"
                        required>
...
<div class="modal fade" id="verifModal{{ $user->id }}" tabindex="-1" aria-labelledby="verifModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
